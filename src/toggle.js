...
module.exports = _ => {
  ...
  toggle.innerHTML = `
    <div class="Layout-sc-1xcs6mc-0 ScLayoutCssVars-sc-10awzi2-1 gdUPAO"></div>
    <div class="Layout-sc-1xcs6mc-0">
      <div aria-describedby="anu-chat-overlay-toggle-tooltip" class="Layout-sc-1xcs6mc-0 ScAttachedTooltipWrapper-sc-1ems1ts-0 deuUPa">
        <button class="ScCoreButton-sc-ocjdkq-0 dNGoHt ScButtonIcon-sc-9yap0r-0 eekshR" aria-label="Anu Chat Overlay" data-a-target="anu-chat-overlay-toggle-button">
        ...
        <div class="ScAttachedTooltip-sc-1ems1ts-1 dkeAyr tw-tooltip" data-a-target="tw-tooltip-label" role="tooltip" id="anu-chat-overlay-toggle-tooltip" direction="top">Anu Chat Overlay</div>
      </div>
    </div>
  `
  return toggle
