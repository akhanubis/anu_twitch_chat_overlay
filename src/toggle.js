...
module.exports = _ => {
  ...
  toggle.innerHTML = `
    ...
    <div id="anu-chat-overlay-toggle-tooltip" class="ScAttachedTooltip-sc-1ems1ts-1 jbYXBT tw-tooltip" data-a-target="anu-chat-overlay-toggle-button" role="tooltip" direction="top">
      Anu Chat Overlay
    </div>
  `
  return toggle
